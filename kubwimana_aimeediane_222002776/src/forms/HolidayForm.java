...
public class HolidayForm implements ActionListener {

	JFrame frame;
	JLabel ulb=new JLabel("ID:");
	JLabel fnlb=new JLabel("EMPLOYEE_Name:");
	JLabel lnlb=new JLabel("HOLIDAYTYPE:");
	JLabel plb=new JLabel("STARTDATE:");
	JLabel emlb=new JLabel("ENDDATE:");
	JLabel adlb=new JLabel("DOCUMENT:");
	...
	adtxf.setBounds(200, 260, 200, 30);
     sendbtn.setBounds(50, 300,90, 40);
     conbtn.setBounds(150, 300, 90, 40);
     cobtn.setBounds(250, 300, 90, 40);
     addcomponent();
	...
	cobtn.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			UserInterface emp=new UserInterface();
			((Component) emp.frame).setVisible(true);
			frame.dispose();
		}
	});
	...
	public static void main(String[] args) {
		HolidayForm attend=new HolidayForm();
